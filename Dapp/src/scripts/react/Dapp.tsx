          ...
          <div className="no-wallet">
            ...
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2>HOOTLES</h2>
                <p>
                Hootles is a NFT (non fungible token) collection of 3,333 friendly owls waiting to be loved on the Polygon blockchain.<strong> They are created by the German scientist turned artist, Dr. Bane.</strong> The collection is made up of hundreds of traits curated by Dr. Bane himself. Hand-drawn Hootles are in different moods and include dozens of rare headgears, attires, background. Hootles are very simple and so is their thought. 
                They are here to spread love, radiate positivity and be loved. 
                <strong> Be hootled, be loved.</strong> 
